...
public interface ICharacter
{
    ...
    float MleeDamage { get; set; }
    float base_MleeDamage { get; set; }
    float MleeDefence { get; set; }
    float base_MleeDefence { get; set; }
    #region 신체 체력
    int Body_Hp { get; set; }
    int Arm_Hp { get; set; }
    int Head_Hp { get; set; }
...
public class PlayerCharacter : ICharacter
{
    ...
    public float MleeDamage { get; set; } = 2f;
    public float base_MleeDamage { get; set; } = 2f;
    public float MleeDefence { get; set; } = 2f;
    public float base_MleeDefence { get; set; } = 2f;
...
public class Monster2 : ICharacter
{
    public Monster2()
    {
        Initialize(new NormalShotgun());
        DropitemLV = UnityEngine.Random.Range(1, 6);
        Debug.Log(DropitemLV);
        //Distance = UnityEngine.Random.Range(40, 70);
        Distance = 30;
    }
    float Round(float value, int decimals = 2)
    {
    ...
    */
    ...
    public string Name { get; set; } = "샷건몬";
    public int Level { get; set; } = 1;
    public int DropitemLV { get; set; }
    public int HP { get; set; } = 10;
    public int CurrentHp { get; set; } = 10;
    ...
    #region 애니메이션 관련
    public GameObject anime { get; set; }
    public int animeIndex { get; set; } = 1;
    #endregion
