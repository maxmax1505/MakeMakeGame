...
public interface Flight
{
    ...
    float current_distance { get; set; }
...
public class PlayerShip : Flight
{
    #region 플레이어 스탯
    public int Hull { get; set; }
    public int CurrentHull { get; set; }
    public float distance { get; set; }
    public float speed_Chance { get; set; }
    public float speed_distance { get; set; }
    public float power_damage { get; set; }
    public float power_chance { get; set; }
    public float evasive { get; set; }
    public float sheild { get; set; }
    public float current_sheild { get; set; }
    public float shield_One { get; set; }
    public float current_distance { get; set; }
